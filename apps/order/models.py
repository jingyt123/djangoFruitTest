...
class OrderInfo(BaseModel):
    ...
    pay_memthod=models.SmallIntegerField(choices=pay_memthod_choices,default=3,verbose_name='支付方式')
    total_count=models.IntegerField(default=1,verbose_name='商品数量')
    total_price=models.DecimalField(max_digits=10,decimal_places=2,verbose_name='商品总价')# DecimalField 固定精度的十进制数的字段
...
class OrderGoods(BaseModel):
    ...
    sku = models.ForeignKey('goods.GoodSKU', verbose_name='商品SKU', on_delete=models.CASCADE)
